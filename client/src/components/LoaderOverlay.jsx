const LoaderOverlay = () => (
  <div className="absolute inset-0 bg-white backdrop-blur-sm flex items-center justify-center z-50">
    <button
      disabled
      className="flex items-center gap-3 bg-white text-black px-6 py-3 rounded-xl shadow-lg text-lg font-semibold"
    >
      <svg
        aria-hidden="true"
